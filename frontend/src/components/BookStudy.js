...
function BookStudy() {
  return (
    <>
      <h2 className={style.title}>북스터디</h2>
      <div className={style.bookStudy}>
        <p>
          <span>북스터디</span>는 청소년과 성인을 위한{" "}
          <span>북악하늘 작은도서관</span>의 상시 프로그램 중 하나입니다.
        </p>
        <div id="about" className={style.container}>
          <h3 className={style.subtitle}>북악하늘의 북스터디는?</h3>
        ...
        <div id="hours" className={style.container}>
          <h3 className={style.subtitle}>북스터디 일정</h3>
          <div className={style.content}>
        ...
        <div id="participate" className={style.container}>
          <h3 className={style.subtitle}>북스터디 참여 방법</h3>
          <div className={style.content}>
