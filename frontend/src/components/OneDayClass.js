...
function OneDayClass() {
  return (
    <>
      <h2 className={style.title}>원데이 클래스</h2>
      <div id={style["oneday-class"]}>
        ...
        <div id="about" className={style.container}>
          <h3 className={style.subtitle}>북악하늘의 원데이 클래스는?</h3>
        ...
        <div id="hours" className={style.container}>
          <h3 className={style.subtitle}>원데이 클래스 일정</h3>
          <div className={style.content}>
        ...
        <div id="participate" className={style.container}>
          <h3 className={style.subtitle}>원데이 클래스 참여 방법</h3>
          <div className={style.content}>
