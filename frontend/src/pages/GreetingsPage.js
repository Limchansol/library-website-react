  ...
  return (
    <div className="greetings">
      <p>
        ...
        <br /><br />
        현재 이곳(508단지)에는 상업시설뿐 아니라 사회복지와 문화적 시설이 거의 전무한 상태입니다. 서울 한복판에 있으면서도 도시적 이점을 누리지 못하며, 베드타운(bed town)의 역할만 감당할 뿐입니다. 때문에 하나님 나라의 복음 안에서 사회·문화적 필요를 충족하고 이웃과의 건전한 만남을 통해 활기찬 우리 동네가 만들어지기를 소망하는 마음으로 소통 의 공간(場)인 카페형 작은도서관을 시작하였습니다.
        <br />
